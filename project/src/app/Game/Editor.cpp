...
void Editor::updateWaitForMapState(float ) {
...
void Editor::updateLoadingState(float ) {
...
void Editor::updateEditing(float ) {
...
void Editor::updateSaving(float ) {

}

void Editor::updateClosing(float ) {
...
void Editor::renderGizmo(ShaderSettings& shaderSettings) {
	...
	shaderSettings.activeShader->bindData(shaderSettings.reflectionMatrixLocation, UniformDataType::UNI_MATRIX4X4, &tmpMap);
	shaderSettings.activeShader->bindData(shaderSettings.clipPlaneLocation, UniformDataType::UNI_FLOAT4, &tmpVec4);
