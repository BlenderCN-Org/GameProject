...
bool ShaderObject_gl::buildShader() {
	bool success = true;
...
int ShaderObject_gl::getShaderUniform(char * uniformName) {
...
void ShaderObject_gl::bindDataArray(int location, UniformDataType , void* data, unsigned int count) {
	float* d = (float*)data;
